...
class ReplSkin:
    ...
    def create_prompt_session(self):
        ...
        """
        # prompt_toolkit's Windows console backend requires a real TTY/console
        # handle. When the CLI is driven by subprocess pipes for tests or agent
        # automation, fall back to plain input() instead of crashing.
